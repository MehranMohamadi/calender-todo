      ...
      {days.map((day, index) => {
        ...
        return (
          <div
            ...
            className={cn(
              "group flex flex-1 cursor-pointer flex-col gap-2 rounded-xl border bg-card p-3 text-right transition-all hover:shadow-sm sm:flex-row sm:items-stretch sm:gap-4",
